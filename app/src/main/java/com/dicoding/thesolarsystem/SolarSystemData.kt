...
object SolarSystemData {
    private val solarSystemNames = arrayOf("Sun",
        "Mercury",
        "Venus",
        "Earth",
        "Moon",
    ...
    private val solarSystemsImages = intArrayOf(R.drawable.sun,
        R.drawable.mercury,
        R.drawable.venus,
        R.drawable.earth,
        R.drawable.moon,
    ...
    val listData: ArrayList<SolarSystem>
        get() {
            ...
            for (position in solarSystemNames.indices) {
                val solarSystem = SolarSystem()
                solarSystem.name = solarSystemNames[position]
                solarSystem.detail = solarSystemDetails[position]
                solarSystem.photo = solarSystemsImages[position]
